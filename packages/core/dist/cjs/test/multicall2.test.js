...
var sendEmptyTx_1 = require("./utils/sendEmptyTx");
...
describe('Multicall2', function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, ethereum_waffle_1.deployContract(deployer, src_1.MultiCall2)];
                case 2:
    ...
    it('Retrieves token balance using tryAggregate', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    blockNumber = _b.sent();
                    return [4 /*yield*/, src_1.multicall2(mockProvider, multicallContract.address, blockNumber, [call])];
                case 2:
                    result = _b.sent();
                    _a = result[tokenContract.address][data] || {}, value = _a.value, success = _a.success;
                    chai_1.expect(success).to.be["true"];
                    chai_1.expect(bignumber_1.BigNumber.from(value)).to.eq('10000');
                    return [2 /*return*/];
            }
        });
    }); });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, chai_1.expect(src_1.multicall2(mockProvider, multicallContract.address, blockNumber, [call])).to.be.eventually.rejected];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, sendEmptyTx_1.sendEmptyTx(deployer)];
                case 1:
                    _b.sent();
                    return [4 /*yield*/, mockProvider.getBlockNumber()];
                case 2:
    ...
    it('Does not fail when doing multiple calls at once', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    erc20Interface = new abi_1.Interface(src_1.ERC20Mock.abi);
                    calls = [
                        {
                            address: tokenContract.address,
                ...
                case 1:
                    blockNumber = _d.sent();
                    return [4 /*yield*/, src_1.multicall2(mockProvider, multicallContract.address, blockNumber, calls)];
                case 2:
                    result = _d.sent();
                    _a = result[calls[0].address][calls[0].data] || {}, value = _a.value, success = _a.success;
                    chai_1.expect(value).to.equal(bignumber_1.BigNumber.from(10000));
                    chai_1.expect(success).to.be["true"];
                    ...
                    chai_1.expect(decodedSymbol).to.equal('MOCK');
                    chai_1.expect(success).to.be["true"];
                    (_c = result[calls[2].address][calls[2].data] || {}, value = _c.value, success = _c.success);
                    chai_1.expect(value).to.equal(bignumber_1.BigNumber.from(0));
                    chai_1.expect(success).to.be["true"];
                    return [2 /*return*/];
            }
        });
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    ...
                    chai_1.expect(decodedValue).to.equal('ERC20: transfer amount exceeds balance');
